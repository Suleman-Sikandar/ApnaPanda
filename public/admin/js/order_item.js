$(document).ready(function () {
    ...
    $('.editOrderItem').on('click', function (e) {
        ...
        // Fetch record
        $.ajax({
            url: '/admin/order-items/edit/' + editItemId,
            method: 'GET',
    ...
    $('#editOrderItemForm').off('submit').on('submit', function (e) {
        ...
        $.ajax({
            url: '/admin/order-items/update/' + editItemId,
            method: 'POST',
            data: formData,
            contentType: false,
            processData: false,
    ...
    // DELETE ORDER ITEM
    // =======================
    $('.deleteOrderItem').on('click', function (e) {
        e.preventDefault();
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '/admin/order-items/delete/' + id,
                    method: 'DELETE',
                    headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
