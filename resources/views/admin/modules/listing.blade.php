    ...
    <div class="role-dashboard-container">
        ...
        <div class="role-header-card">
            ...
            <div class="role-header-actions">
                @if (validatePermissions('admin/modules/store'))
        ...
        <div class="admin-roles-grid-container">
            @foreach ($modules as $mod)
                <div class="admin-role-card" id="module-{{ $mod->id }}">
                    ...
                    <span
                        class="admin-role-status-badge {{ $mod->is_active ? 'admin-role-status-active' : 'admin-role-status-inactive' }}">
                    ...
                    <div class="admin-role-card-footer">
                        @if (validatePermissions('admin/modules/edit/{id}'))
                            <button class="admin-role-action-btn admin-role-btn-edit editModule" title="Edit Module"
                                data-id="{{ $mod->id }}">
                                <i class="bi bi-pencil"></i> Edit Module
                            </button>
                        @endif
                        @if (validatePermissions('admin/modules/delete/{id}'))
                            <button class="admin-role-action-btn admin-role-btn-delete module-btn-delete"
                                title="Delete Module" data-id="{{ $mod->id }}">
