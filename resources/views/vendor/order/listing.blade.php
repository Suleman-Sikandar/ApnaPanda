    ...
    <div class="role-dashboard-container">
        ...
        <div class="role-header-card">
            <div class="role-header-left">
                ...
                <p class="role-page-subtitle">Manage your orders.</p>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="role-action-buttons">
                                    {{-- <button class="role-btn-icon role-btn-view" title="View Order"
                                        onclick="window.location='{{ route('vendor.orders.detail', $order->id) }}'">
                                        <i class="bi bi-eye"></i>
                                    </button> --}}

                                    <button class="role-btn-icon role-btn-edit editOrder" title="Edit"
                                        data-id="{{ $order->id }}">
                                        <i class="bi bi-pencil"></i>
                                    </button>

                                    <button class="role-btn-icon role-btn-delete deleteOrder" title="Delete"
                                        data-id="{{ $order->id }}">
        ...
        @include('vendor.order.modals.add')
        @include('vendor.order.modals.edit')
...
@push('scripts')
    <script src="{{ asset('vendor/js/order.js') }}"></script>

    <!-- Google Maps API -->
    <script
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCxAPwCneWCcdxQFDOLJ_hGMJk1ruf5AwU&libraries=places&callback=initAllAutocompletes"
        async defer></script>
    ...
    <script>
        ...
        function initAllAutocompletes() {
            ...
            setupMap("map-add", "delivery_address", mapAdd, markerAdd, "latitude_add", "longitude_add", "city_add",
                "province_add", "country_add", "postal_code_add");
            ...
            setupMap("map-edit", "edit_delivery_address", mapEdit, markerEdit, "latitude_edit", "longitude_edit",
                "city_edit", "province_edit", "country_edit", "postal_code_edit");
        }
